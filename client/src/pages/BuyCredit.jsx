    ...
    <div className='min-h-[80vh] pt-14 mb-10 text-center'>
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {plans.map((item,index)=>(
          <div className='bg-white drop-shadow-sm border rounded-lg py-11 px-8 text-gray-700 hover:scale-105 transition-all duration-500' key={index}>
            <img className='mb-5' width={40} src={assets.logo_icon} alt="" />
